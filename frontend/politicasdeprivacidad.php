        ...
        <section class="pp-card animate-in animate-delay-2">
          <div class="pp-card-inner">
            ...
            <div class="pp-section" id="pp-4">
              <div class="pp-h"><span>4. Compartir su información</span></div>
              <p class="pp-text">
  ...
  <div id="overlayMobilePopup" class="mobile-popup-overlay lg:hidden">
    <div class="mobile-popup-modal">
        ...
        <div class="mobile-popup-body">
            <a href="#pp-1" class="mobile-popup-link"><span>1. Quiénes somos</span><i class="ph-caret-right"></i></a>
            <a href="#pp-2" class="mobile-popup-link"><span>2. Información</span><i class="ph-caret-right"></i></a>
            <a href="#pp-3" class="mobile-popup-link"><span>3. Uso</span><i class="ph-caret-right"></i></a>
            <a href="#pp-4" class="mobile-popup-link"><span>4. Compartir</span><i class="ph-caret-right"></i></a>
            <a href="#pp-5" class="mobile-popup-link"><span>5. Seguridad</span><i class="ph-caret-right"></i></a>
            <a href="#pp-6" class="mobile-popup-link"><span>6. Cookies</span><i class="ph-caret-right"></i></a>
            <a href="#pp-7" class="mobile-popup-link"><span>7. Contenido incrustado</span><i class="ph-caret-right"></i></a>
            <a href="#pp-8" class="mobile-popup-link"><span>8. Con quién compartimos</span><i class="ph-caret-right"></i></a>
            <a href="#pp-9" class="mobile-popup-link"><span>9. Retención</span><i class="ph-caret-right"></i></a>
            <a href="#pp-10" class="mobile-popup-link"><span>10. Derechos</span><i class="ph-caret-right"></i></a>
            <a href="#pp-11" class="mobile-popup-link"><span>11. Transferencias</span><i class="ph-caret-right"></i></a>
            <a href="#pp-12" class="mobile-popup-link"><span>12. Cambios</span><i class="ph-caret-right"></i></a>
            <a href="#pp-13" class="mobile-popup-link"><span>13. Contacto</span><i class="ph-caret-right"></i></a>
        </div>
    </div>
  </div>
